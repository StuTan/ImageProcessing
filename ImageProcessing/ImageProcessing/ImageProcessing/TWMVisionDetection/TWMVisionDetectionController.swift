...
class TWMVisionDetectionController: UIViewController {
     
 
    @IBOutlet weak var previewView: TWMVisionDetectionPreviewView!
    ...
    override func viewDidLoad() {
        ...
        self.view.addSubview(TWMVisionDetectionPreviewView())
...
// Video Sessions
extension TWMVisionDetectionController {
...
extension TWMVisionDetectionController: AVCaptureVideoDataOutputSampleBufferDelegate {
