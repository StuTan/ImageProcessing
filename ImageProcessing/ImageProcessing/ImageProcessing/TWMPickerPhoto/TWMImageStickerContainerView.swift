//
//  TWMTWMImageStickerContainerView.swift
//  ImageProcessing
//
...
class TWMImageStickerContainerView: UIView, ZLImageStickerContainerDelegate {
    ...
    override func layoutSubviews() {
        ...
        let path = UIBezierPath(roundedRect: CGRect(x: 0, y: 0, width: self.frame.width, height: TWMImageStickerContainerView.baseViewH), byRoundingCorners: [.topLeft, .topRight], cornerRadii: CGSize(width: 8, height: 8))
    ...
    func setupUI() {
        ...
        self.baseView.snp.makeConstraints { (make) in
            ...
            make.bottom.equalTo(self.snp.bottom).offset(TWMImageStickerContainerView.baseViewH)
            make.height.equalTo(TWMImageStickerContainerView.baseViewH)
        }
...
extension TWMImageStickerContainerView: UIGestureRecognizerDelegate {
...
extension TWMImageStickerContainerView: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
