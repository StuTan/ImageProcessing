...
//        var label: UILabel = UILabel.init(frame: CGRect(x: 0, y: 0, width: kScreenW, height: kScreenH))
//        label.text = "hello"
//        return label
//    }()
//
...
class TWMPickerPhotoController: UIViewController {
    ...
    deinit {
        for label in TWMPickerPhotoController.propertyLabel {
...
extension TWMPickerPhotoController: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
